...
class User(models.Model):
    ...
    national_id = models.CharField(max_length=20, null=True, blank=True, unique=True, validators=[RegexValidator(regex=r'^\d{14}$', message=_("Enter a valid national ID."))])
